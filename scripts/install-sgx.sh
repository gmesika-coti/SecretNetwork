...
install_psw(){
    ...
    wget -O /tmp/libprotobuf17_3.6.1.3-2_amd64.deb http://ftp.br.debian.org/debian/pool/main/p/protobuf/libprotobuf17_3.6.1.3-2_amd64.deb
    (sleep 3 ; echo y) | sudo gdebi /tmp/libprotobuf17_3.6.1.3-2_amd64.deb
